...
* Name – Katakamsetty Bala Bhargavi 
...
The code is availaible at : https://github.com/balabhargaviammu/Machine-Predictive-Maintainence-Anomaly-Detection/blob/main/anomaly_detector_ML_project.ipynb (in this repository itself ) .
